class ParticleView extends ViewBase {
    ...
    void beforeDrawChildren() {
        if (particleModel instanceof FoodParticleModel) {
            ...
            image(img, particleModel.getPosition().x - 12 + 10, particleModel.getPosition().y - 12 + 10);
            ...
            image(img, wasteParticle.getPosition().x - 12 + 10, wasteParticle.getPosition().y - 12 + 10);
        }
    }
}
